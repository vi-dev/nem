...
func (alreadyExistsTarget) Fetch(_ context.Context, _ ocispec.Descriptor) (io.ReadCloser, error) {
	return nil, errdef.ErrNotFound
}

func (alreadyExistsTarget) Exists(_ context.Context, _ ocispec.Descriptor) (bool, error) {
	return false, nil
}

func (alreadyExistsTarget) Push(_ context.Context, _ ocispec.Descriptor, _ io.Reader) error {
	return errdef.ErrAlreadyExists
}

func (alreadyExistsTarget) Tag(_ context.Context, _ ocispec.Descriptor, _ string) error {
	return errdef.ErrUnsupported
}

func (alreadyExistsTarget) Resolve(_ context.Context, _ string) (ocispec.Descriptor, error) {
